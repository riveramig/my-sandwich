...
import { AddSandwich, ReduceQuantitySandwich, RemoveSandwich, SendCart } from 'src/app/store/cart/cart.actions';
import { selectAllSandwichesInCart, selectCurrentTotalInCart } from 'src/app/store/cart/cart.selector';
import { CartItem, CartItemDto, CartState } from 'src/app/store/cart/cart.state';
...
export class ShoppingCartComponent implements OnInit {
  ...
  public sendCart() {
    this.store.dispatch(new SendCart())
  }
